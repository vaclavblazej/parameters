...
providers: [ISGCI](https://www.graphclasses.org/classes/par_29.html)

**Definition:** Minimum number of vertices removed to make the graph into [cluster]({{< base >}}html/WAU7vf)
...
| [distance to cluster]({{< base >}}html/aXw3Co) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
