---
title: "strong d-coloring number"
---# strong d-coloring number

functionally equivalent to: [d-admissibility]({{< base >}}html/Pqiy2C)



<p><div id="../local_yihnem.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../local_yihnem.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../local_yihnem.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>

<p><div id="../graph_property_inclusions_yihnem.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../graph_property_inclusions_yihnem.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../graph_property_inclusions_yihnem.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>

<p><div id="../parameter_inclusions_yihnem.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../parameter_inclusions_yihnem.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../parameter_inclusions_yihnem.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>
...
| [admissibility]({{< base >}}html/v4sLfO) | <span style="display:none">lime</span><span style="color:#00ff00">■</span> | upper bound | unknown to HOPS |
...
| [bounded expansion]({{< base >}}html/lFz6Ci) | <span style="display:none">lime</span><span style="color:#00ff00">■</span> | upper bound | unknown to HOPS |
| [boxicity]({{< base >}}html/a7MpiT) | <span style="display:none">gray</span><span style="color:#bebebe">■</span> | unknown to HOPS | unknown to HOPS |
...
| [complete]({{< base >}}html/EhdXNA) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
...
| [d-admissibility]({{< base >}}html/Pqiy2C) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | upper bound | upper bound |
...
| [distance to cluster]({{< base >}}html/aXw3Co) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
...
| [distance to complete]({{< base >}}html/2LDMQ6) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
...
| [strong coloring number]({{< base >}}html/PxVh3F) | <span style="display:none">lime</span><span style="color:#00ff00">■</span> | upper bound | unknown to HOPS |
| [strong d-coloring number]({{< base >}}html/yihnem) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
...
| [twin-cover number]({{< base >}}html/MUnHA0) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
...
| [weak coloring number]({{< base >}}html/KD6n2n) | <span style="display:none">lime</span><span style="color:#00ff00">■</span> | upper bound | unknown to HOPS |
...
| [weakly sparse and merge width]({{< base >}}html/HJjpOL) | <span style="display:none">lime</span><span style="color:#00ff00">■</span> | upper bound | unknown to HOPS |
...
* [unknown source]({{< base >}}html/myit4D)
    * [strong d-coloring number]({{< base >}}html/yihnem) upper bounds [d-admissibility]({{< base >}}html/Pqiy2C) by a linear function -- by definition
    * [d-admissibility]({{< base >}}html/Pqiy2C) upper bounds [strong d-coloring number]({{< base >}}html/yihnem) by a tower function -- $col_d \le 1+(adm_d)^d$
    * [strong d-coloring number]({{< base >}}html/yihnem) upper bounds [weak d-coloring number]({{< base >}}html/3F3oc3) by a tower function -- $wcol_d \le \sum_{i=0}^d(col_d-1)^i$
    * [strong coloring number]({{< base >}}html/PxVh3F) upper bounds [strong d-coloring number]({{< base >}}html/yihnem) by a computable function