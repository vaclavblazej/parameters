...
equivalent to: [branch width]({{< base >}}html/lIcmuR), [treewidth]({{< base >}}html/5Q7fuR), [mm-width]({{< base >}}html/d7vRYU)
...
| [branch width]({{< base >}}html/lIcmuR) | upper bound | upper bound |
...
| [tree-independence number]({{< base >}}html/fNR6QK) | unknown to HOPS | upper bound |
| [treedepth]({{< base >}}html/KEP2qM) | upper bound | exclusion |
| [treelength]({{< base >}}html/JA2nKw) | exclusion | unknown to HOPS |
| [treewidth]({{< base >}}html/5Q7fuR) | upper bound | upper bound |
