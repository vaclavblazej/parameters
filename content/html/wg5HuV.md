...
functionally equivalent to: [module-width]({{< base >}}html/EV3FqL), [NLC-width]({{< base >}}html/Xrpbv7), [radius-inf flip-width]({{< base >}}html/nYXiuT), [rank-width]({{< base >}}html/fojquT), [boolean width]({{< base >}}html/A2jPWT)
