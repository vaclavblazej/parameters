...
**Definition:** Minimum $k$ such that for some order of vertices $\prec$ there is a $k$-partition of edges so that no two edges $ab$ and $cd$ cross, i.e., $a \prec c \prec b \prec d$.
