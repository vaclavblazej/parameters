...
functionally equivalent to: [h-index]({{< base >}}html/GNTwUS)

**Definition:** Minimum number of vertices removed to make the graph into [maximum degree]({{< base >}}html/UyQ5yM)
...
| [admissibility]({{< base >}}html/v4sLfO) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | exclusion | unknown to HOPS |
...
| [bounded expansion]({{< base >}}html/lFz6Ci) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | exclusion | unknown to HOPS |
...
| [excluded top-minor]({{< base >}}html/yOZQM5) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | exclusion | unknown to HOPS |
...
| [strong coloring number]({{< base >}}html/PxVh3F) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | exclusion | unknown to HOPS |
...
| [weak coloring number]({{< base >}}html/KD6n2n) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | exclusion | unknown to HOPS |
...
| [weakly sparse and merge width]({{< base >}}html/HJjpOL) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | exclusion | unknown to HOPS |
