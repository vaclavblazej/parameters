...
equivalent to: [cutwidth]({{< base >}}html/TLx1pz), [pathwidth+maxdegree]({{< base >}}html/6BWcgd)
...
| [bandwidth]({{< base >}}html/aP5a38) | non-tight bounds | unknown to HOPS |
...
| [pathwidth+maxdegree]({{< base >}}html/6BWcgd) | upper bound | upper bound |
...
| [topological bandwidth]({{< base >}}html/SnA7Eq) | unknown to HOPS | unknown to HOPS |
