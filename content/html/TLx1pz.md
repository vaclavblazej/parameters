...
functionally equivalent to: [pathwidth+maxdegree]({{< base >}}html/6BWcgd)

providers: [ISGCI](https://www.graphclasses.org/classes/par_15.html)

**Definition:** Minimum over vertex orders, maximum over positions (between vertices), number of edges that have endpoints on different sides of the position.



<p><div id="../local_TLx1pz.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../local_TLx1pz.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../local_TLx1pz.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>

<p><div id="../graph_property_inclusions_TLx1pz.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../graph_property_inclusions_TLx1pz.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../graph_property_inclusions_TLx1pz.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>

<p><div id="../parameter_inclusions_TLx1pz.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../parameter_inclusions_TLx1pz.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../parameter_inclusions_TLx1pz.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>
...
| [bandwidth]({{< base >}}html/aP5a38) | <span style="display:none">lime</span><span style="color:#00ff00">■</span> | non-tight bounds | unknown to HOPS |
...
| [carving-width]({{< base >}}html/dS6OgO) | <span style="display:none">orange</span><span style="color:#ff8c00">■</span> | unknown to HOPS | upper bound |
...
| [contraction complexity]({{< base >}}html/LlWzhg) | <span style="display:none">orange</span><span style="color:#ff8c00">■</span> | unknown to HOPS | upper bound |
| [cutwidth]({{< base >}}html/TLx1pz) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
...
| [degree treewidth]({{< base >}}html/nCWUh3) | <span style="display:none">orange</span><span style="color:#ff8c00">■</span> | unknown to HOPS | upper bound |
...
| [domino treewidth]({{< base >}}html/aEs5ap) | <span style="display:none">orange</span><span style="color:#ff8c00">■</span> | unknown to HOPS | upper bound |
...
| [pathwidth+maxdegree]({{< base >}}html/6BWcgd) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | upper bound | upper bound |
...
| [treespan]({{< base >}}html/IbKkUQ) | <span style="display:none">orange</span><span style="color:#ff8c00">■</span> | unknown to HOPS | upper bound |
...
* [assumed]({{< base >}}html/9kg0oo)
    * [cutwidth]({{< base >}}html/TLx1pz) is equivalent to [cutwidth]({{< base >}}html/TLx1pz) -- assumed
