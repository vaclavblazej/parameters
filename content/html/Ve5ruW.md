...
equivalent to: [distance to bipartite]({{< base >}}html/1yW82F), [odd cycle transversal]({{< base >}}html/Ve5ruW)
...
| [bipartite]({{< base >}}html/cLHJkW) | constant | unknown to HOPS |
...
| [distance to bipartite]({{< base >}}html/1yW82F) | equal | equal |
