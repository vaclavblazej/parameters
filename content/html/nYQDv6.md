---
title: "edge clique cover number"
---# edge clique cover number

tags: [covering edges]({{< base >}}html/tK4S1r)

**Definition:** Edge clique cover number is the minimum number of clique subgraphs that cover every edge of the graph.
...
| [edge clique cover number]({{< base >}}html/nYQDv6) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
