---
title: "linear clique-width"
---# linear clique-width

tags: [linear variant]({{< base >}}html/nAjQi4)

functionally equivalent to: [linear NLC-width]({{< base >}}html/v09DMY), [linear rank-width]({{< base >}}html/cHugsk)

**Definition:** Minimum number of labels (colors) required to construct the graph using the following operations for constructing labeled graphs: 1) create a new labeled vertex, 2) union with a single labeled vertex, 3) complete join between two labels, and 4) change all vertices from one to another label.
...
| [linear clique-width]({{< base >}}html/fQj3wU) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
| [linear forest]({{< base >}}html/skQuFN) | <span style="display:none">green</span><span style="color:#006400">■</span> | upper bound | exclusion |
| [linear NLC-width]({{< base >}}html/v09DMY) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | upper bound | upper bound |
...
* 2015 [Linear rank-width and linear clique-width of trees by Adler, Kanté]({{< base >}}html/rhj9my)
...
* 2009 [Clique-Width is `NP`-Complete by Fellows, Rosamond, Rotics, Szeider]({{< base >}}html/zuhSo5)
