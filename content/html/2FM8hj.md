---
title: "sparse twin-width"
---# sparse twin-width

**Definition:** an intersetcion of  [twin-width]({{< base >}}html/OrH7et), and [bounded expansion]({{< base >}}html/lFz6Ci)
...
| --- | --- | --- | --- |
| [acyclic chromatic number]({{< base >}}html/QGZuUW) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | exclusion | unknown to HOPS |
...
| [sparse twin-width]({{< base >}}html/2FM8hj) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
