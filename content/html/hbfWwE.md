---
title: "distance to co-cluster"
---# distance to co-cluster

providers: [ISGCI](https://www.graphclasses.org/classes/par_3.html)

**Definition:** Minimum number of vertices removed to make the graph into [co-cluster]({{< base >}}html/7HR4uV)
...
| [distance to co-cluster]({{< base >}}html/hbfWwE) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
