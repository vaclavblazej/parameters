...
functionally equivalent to: [feedback vertex set]({{< base >}}html/GNOiyB)

**Definition:** Minimum number of vertices removed to make the graph into [forest]({{< base >}}html/JngPPm)
