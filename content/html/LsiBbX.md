...
**Definition:** A graph with no edges.



<p><div id="../local_LsiBbX.dot" class="svg-diagram"></div></p><script>Viz.instance().then(function(viz) {fetch('../local_LsiBbX.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);svg.setAttribute("width", "100%");svg.setAttribute("height", "300pt");document.getElementById("../local_LsiBbX.dot").appendChild(svg);svgPanZoom(svg, {zoomEnabled: true,zoomScaleSensitivity: 0.3,minZoom: 0.9,maxZoom: 6,});})});</script>

<p><div id="../dif_inclusions_LsiBbX.dot" class="svg-diagram"></div></p><script>Viz.instance().then(function(viz) {fetch('../dif_inclusions_LsiBbX.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);svg.setAttribute("width", "100%");svg.setAttribute("height", "300pt");document.getElementById("../dif_inclusions_LsiBbX.dot").appendChild(svg);svgPanZoom(svg, {zoomEnabled: true,zoomScaleSensitivity: 0.3,minZoom: 0.9,maxZoom: 6,});})});</script>

<p><div id="../same_inclusions_LsiBbX.dot" class="svg-diagram"></div></p><script>Viz.instance().then(function(viz) {fetch('../same_inclusions_LsiBbX.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);svg.setAttribute("width", "100%");svg.setAttribute("height", "300pt");document.getElementById("../same_inclusions_LsiBbX.dot").appendChild(svg);svgPanZoom(svg, {zoomEnabled: true,zoomScaleSensitivity: 0.3,minZoom: 0.9,maxZoom: 6,});})});</script>
...
| [bounded components]({{< base >}}html/t7c4mp) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | upper bound |
...
| [cluster]({{< base >}}html/WAU7vf) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | inclusion |
...
| [diameter+max degree]({{< base >}}html/ri9Seh) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | upper bound |
...
| [linear forest]({{< base >}}html/skQuFN) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | inclusion |
...
| [stars]({{< base >}}html/10JR3F) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | inclusion |
