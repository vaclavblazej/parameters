...
| 028 | 2007 | [Graph Treewidth and Geometric Thickness Parameters by Dujmovic, Wood]({{< base >}}html/2q7m9E) |
| 029 | 2006 | [Approximating clique-width and branch-width by Oum, Seymour]({{< base >}}html/1ZTWBd) |
| 030 | 2005 | [On the relationship between NLC-width and linear NLC-width by Gurski, Wanke]({{< base >}}html/FLSQsw) |
| 031 | 2004 | [Track Layouts of Graphs by Dujmović, Pór, Wood]({{< base >}}html/w7RVn9) |
| 032 | 2000 | [Upper bounds to the clique width of graphs by Courcelle, Olariu]({{< base >}}html/ZQrXS8) |
| 033 | 1998 | [Clique-decomposition, NLC-decomposition and modular decomposition—relationships and results for random graphs by Johansson]({{< base >}}html/W2nwG4) |
| 034 | 1998 | [A partial $k$-arboretum of graphs with bounded treewidth by Bodlaender]({{< base >}}html/BOFCWg) |
| 035 | 1994 | [k-NLC graphs and polynomial algorithms by Wanke]({{< base >}}html/SQjcYg) |
| 036 | 1993 | [The Pathwidth and Treewidth of Cographs by Bodlaender, Möhring]({{< base >}}html/a3yKzk) |
| 037 | 1991 | [Graph minors. X. Obstructions to tree-decomposition by Robertson, Seymour]({{< base >}}html/1hPzXs) |
| 038 | 1986 | [Graph minors. V. Excluding a planar graph by Robertson, Seymour]({{< base >}}html/A82svt) |
| 039 | 1994 | [Genus g Graphs Have Pagenumber O(√g) by Malitz]({{< base >}}html/cCrsoK) |
| 040 | 1993 | [On the chordality of a graph by McKee, Scheinerman]({{< base >}}html/IFY0Rw) |
| 041 | 1986 | [Graph minors. II. Algorithmic aspects of tree-width by Robertson, Seymour]({{< base >}}html/i56ihO) |
| 042 | 1988 | [The average distanceisnot morethan the independence number by Chung]({{< base >}}html/ePpmZt) |
| 043 | 1985 | [On the Cutwidth and the Topological Bandwidth of a Tree by Chung]({{< base >}}html/DkY1Aq) |
