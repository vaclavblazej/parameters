...
1. an intersetcion of  [connected]({{< base >}}html/KlMP0i), and [linear forest]({{< base >}}html/skQuFN)
1. Vertices can be ordered such that exactly those next to each other in the order are connected by an edge.



<p><div id="../local_ryPlqz.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../local_ryPlqz.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../local_ryPlqz.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>

<p><div id="../graph_property_inclusions_ryPlqz.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../graph_property_inclusions_ryPlqz.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../graph_property_inclusions_ryPlqz.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>

<p><div id="../parameter_inclusions_ryPlqz.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../parameter_inclusions_ryPlqz.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../parameter_inclusions_ryPlqz.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>
...
| [bandwidth]({{< base >}}html/aP5a38) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | exclusion | unknown to HOPS |
...
| [carving-width]({{< base >}}html/dS6OgO) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | upper bound |
...
| [contraction complexity]({{< base >}}html/LlWzhg) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | upper bound |
| [cutwidth]({{< base >}}html/TLx1pz) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | upper bound |
| [cycle]({{< base >}}html/Ti0asF) | <span style="display:none">gray</span><span style="color:#bebebe">■</span> | unknown to HOPS | unknown to HOPS |
| [cycles]({{< base >}}html/2iJr52) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | exclusion | unknown to HOPS |
...
| [degree treewidth]({{< base >}}html/nCWUh3) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | upper bound |
...
| [domino treewidth]({{< base >}}html/aEs5ap) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | upper bound |
...
| [grid]({{< base >}}html/lfYXuK) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | inclusion |
...
| [linear forest]({{< base >}}html/skQuFN) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | upper bound |
...
| [maximum leaf number]({{< base >}}html/BN92vX) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | exclusion | unknown to HOPS |
...
| [path]({{< base >}}html/ryPlqz) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
| [pathwidth]({{< base >}}html/VHClqR) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | upper bound |
| [pathwidth+maxdegree]({{< base >}}html/6BWcgd) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | upper bound |
| [perfect]({{< base >}}html/RmssrZ) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | upper bound |
| [planar]({{< base >}}html/loZ5LD) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | upper bound |
...
| [tree]({{< base >}}html/rJyICu) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | inclusion |
...
| [treespan]({{< base >}}html/IbKkUQ) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | upper bound |
...
* [unknown source]({{< base >}}html/myit4D)
    * graph class [path]({{< base >}}html/ryPlqz) is not constant [treedepth]({{< base >}}html/KEP2qM)
...
* [assumed]({{< base >}}html/9kg0oo)
    ...
    * [path]({{< base >}}html/ryPlqz) is equivalent to [path]({{< base >}}html/ryPlqz) -- assumed