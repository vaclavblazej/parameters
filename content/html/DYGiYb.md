...
```
* Comparing Graph Parameters by Schröder -- Based on the work by [Sa19] as well as [Fr8], we investigate unknown connections between graph parameters to continue the work on the graph parameter hierarchy
* Comparing Graph Parameters by Schröder -- Based on the work by [Sa19] as well as [Fr8], we investigate unknown connections between graph parameters to continue the work on the graph parameter hierarchy
...
* page 20 : bounded [distance to bipartite]({{< base >}}html/1yW82F) does not imply bounded [vertex connectivity]({{< base >}}html/OyLUe4) -- Proposition 3.12
