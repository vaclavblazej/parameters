...
equivalent to: [rank-width]({{< base >}}html/fojquT), [boolean width]({{< base >}}html/A2jPWT), [inf-flip-width]({{< base >}}html/nYXiuT), [clique-width]({{< base >}}html/wg5HuV), [NLC-width]({{< base >}}html/Xrpbv7), [module-width]({{< base >}}html/EV3FqL)

providers: [ISGCI](https://www.graphclasses.org/classes/par_20.html)



<p><div id="../local_fojquT.dot" class="svg-diagram"></div></p><script>Viz.instance().then(function(viz) {fetch('../local_fojquT.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);svg.setAttribute("width", "100%");svg.setAttribute("height", "300pt");document.getElementById("../local_fojquT.dot").appendChild(svg);svgPanZoom(svg, {zoomEnabled: true,zoomScaleSensitivity: 0.3,minZoom: 0.9,maxZoom: 6,});})});</script>

<p><div id="../dif_inclusions_fojquT.dot" class="svg-diagram"></div></p><script>Viz.instance().then(function(viz) {fetch('../dif_inclusions_fojquT.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);svg.setAttribute("width", "100%");svg.setAttribute("height", "300pt");document.getElementById("../dif_inclusions_fojquT.dot").appendChild(svg);svgPanZoom(svg, {zoomEnabled: true,zoomScaleSensitivity: 0.3,minZoom: 0.9,maxZoom: 6,});})});</script>

<p><div id="../same_inclusions_fojquT.dot" class="svg-diagram"></div></p><script>Viz.instance().then(function(viz) {fetch('../same_inclusions_fojquT.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);svg.setAttribute("width", "100%");svg.setAttribute("height", "300pt");document.getElementById("../same_inclusions_fojquT.dot").appendChild(svg);svgPanZoom(svg, {zoomEnabled: true,zoomScaleSensitivity: 0.3,minZoom: 0.9,maxZoom: 6,});})});</script>
...
| [boolean width]({{< base >}}html/A2jPWT) | upper bound | upper bound |
...
| [clique-tree-width]({{< base >}}html/7P9WUz) | upper bound | unknown to HOPS |
| [clique-width]({{< base >}}html/wg5HuV) | upper bound | tight bounds |
...
| [inf-flip-width]({{< base >}}html/nYXiuT) | upper bound | upper bound |
...
| [module-width]({{< base >}}html/EV3FqL) | upper bound | upper bound |
| [neighborhood diversity]({{< base >}}html/vMs3RS) | upper bound | exclusion |
| [NLC-width]({{< base >}}html/Xrpbv7) | upper bound | upper bound |
