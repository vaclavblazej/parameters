...
equivalent to: [domination number]({{< base >}}html/Gq0onN)
...
| [clique cover number]({{< base >}}html/VomShB) | upper bound | unknown to HOPS |
...
| [maximum independent set]({{< base >}}html/mHtXUU) | upper bound | unknown to HOPS |
