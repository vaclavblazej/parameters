...
**Definition:** Minimum over bi-partitions into (almost) equal-sized parts, the number of edges between parts.
...
| [bisection bandwidth]({{< base >}}html/wUdmUb) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
