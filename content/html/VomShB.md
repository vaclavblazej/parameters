...
equivalent to: [clique cover number]({{< base >}}html/VomShB)
...
| [domination number]({{< base >}}html/Gq0onN) | unknown to HOPS | upper bound |
...
| [maximum independent set]({{< base >}}html/mHtXUU) | unknown to HOPS | upper bound |
