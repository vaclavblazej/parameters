...
functionally equivalent to: [distance to forest]({{< base >}}html/hQZlLU)

providers: [PACE](https://pacechallenge.org/2016/)

**Definition:** The minimum set of vertices $S$ such that every cycle in the graph contains at least one vertex of $S$.

**Feedback vertex set**, also called *cycle transversal*, is very simiar to [vertex cover]({{< base >}}html/4lp9Yj) but focuses on cycles instead of edges.
With bounded feedback vertex set, we can partition the graph into a *modulator* of $k$ vertices and a forest.
It generalizes [feedback edge set]({{< base >}}html/HTk9PZ) for the price of having an arbitrary connection from its modulator to the forest.


<p><div id="../local_GNOiyB.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../local_GNOiyB.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../local_GNOiyB.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>

<p><div id="../graph_property_inclusions_GNOiyB.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../graph_property_inclusions_GNOiyB.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../graph_property_inclusions_GNOiyB.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>

<p><div id="../parameter_inclusions_GNOiyB.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../parameter_inclusions_GNOiyB.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../parameter_inclusions_GNOiyB.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>
...
| [distance to forest]({{< base >}}html/hQZlLU) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
...
| [feedback vertex set]({{< base >}}html/GNOiyB) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
...
* [assumed]({{< base >}}html/9kg0oo)
    * [feedback vertex set]({{< base >}}html/GNOiyB) is equivalent to [feedback vertex set]({{< base >}}html/GNOiyB) -- assumed
