---
title: "maximum matching on bipartite graphs"
---# maximum matching on bipartite graphs



<p><div id="../local_8Mm5qJ.dot" class="svg-diagram"></div></p><script>Viz.instance().then(function(viz) {fetch('../local_8Mm5qJ.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);svg.setAttribute("width", "100%");svg.setAttribute("height", "300pt");document.getElementById("../local_8Mm5qJ.dot").appendChild(svg);svgPanZoom(svg, {zoomEnabled: true,zoomScaleSensitivity: 0.3,minZoom: 0.9,maxZoom: 6,});})});</script>

<p><div id="../dif_inclusions_8Mm5qJ.dot" class="svg-diagram"></div></p><script>Viz.instance().then(function(viz) {fetch('../dif_inclusions_8Mm5qJ.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);svg.setAttribute("width", "100%");svg.setAttribute("height", "300pt");document.getElementById("../dif_inclusions_8Mm5qJ.dot").appendChild(svg);svgPanZoom(svg, {zoomEnabled: true,zoomScaleSensitivity: 0.3,minZoom: 0.9,maxZoom: 6,});})});</script>

<p><div id="../same_inclusions_8Mm5qJ.dot" class="svg-diagram"></div></p><script>Viz.instance().then(function(viz) {fetch('../same_inclusions_8Mm5qJ.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);svg.setAttribute("width", "100%");svg.setAttribute("height", "300pt");document.getElementById("../same_inclusions_8Mm5qJ.dot").appendChild(svg);svgPanZoom(svg, {zoomEnabled: true,zoomScaleSensitivity: 0.3,minZoom: 0.9,maxZoom: 6,});})});</script>
...
| [bipartite]({{< base >}}html/cLHJkW) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | unbounded | upper bound |
...
| [block]({{< base >}}html/QrxQsH) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | unbounded | unknown to HOPS |
...
| [chordal]({{< base >}}html/Cv1PaJ) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | unbounded | unknown to HOPS |
...
| [cluster]({{< base >}}html/WAU7vf) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | unbounded | unknown to HOPS |
| [co-cluster]({{< base >}}html/7HR4uV) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | unbounded | unknown to HOPS |
| [cograph]({{< base >}}html/9Qd0Mx) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | unbounded | unknown to HOPS |
...
| [disjoint cycles]({{< base >}}html/AGnF5Z) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | unbounded | unknown to HOPS |
...
| [distance to edgeless]({{< base >}}html/4INs10) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | tight bounds |
...
| [forest]({{< base >}}html/JngPPm) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | unbounded | unknown to HOPS |
...
| [interval]({{< base >}}html/p5skoj) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | unbounded | unknown to HOPS |
...
| [maximum matching on bipartite graphs]({{< base >}}html/8Mm5qJ) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
...
| [outerplanar]({{< base >}}html/0oCyaG) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | unbounded | unknown to HOPS |
...
| [perfect]({{< base >}}html/RmssrZ) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | unbounded | upper bound |
| [planar]({{< base >}}html/loZ5LD) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | unbounded | unknown to HOPS |
...
| [size]({{< base >}}html/F1NpDy) | <span style="display:none">blue</span><span style="color:#0000ff">■</span> | exclusion | exclusion |
| [star]({{< base >}}html/CortlU) | <span style="display:none">green</span><span style="color:#006400">■</span> | upper bound | exclusion |
| [stars]({{< base >}}html/10JR3F) | <span style="display:none">magenta</span><span style="color:#ee82ee">■</span> | unbounded | unknown to HOPS |
...
| [vertex cover]({{< base >}}html/4lp9Yj) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | tight bounds |
