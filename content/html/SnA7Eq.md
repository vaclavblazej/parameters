...
equivalent to: [topological bandwidth]({{< base >}}html/SnA7Eq)
...
| [bandwidth]({{< base >}}html/aP5a38) | upper bound | unknown to HOPS |
...
| [carving-width]({{< base >}}html/dS6OgO) | unknown to HOPS | unknown to HOPS |
...
| [cutwidth]({{< base >}}html/TLx1pz) | unknown to HOPS | unknown to HOPS |
...
| [degree treewidth]({{< base >}}html/nCWUh3) | unknown to HOPS | unknown to HOPS |
...
| [distance to maximum degree]({{< base >}}html/kRR8zx) | exclusion | unknown to HOPS |
...
| [h-index]({{< base >}}html/GNTwUS) | exclusion | unknown to HOPS |
...
| [maximum degree]({{< base >}}html/UyQ5yM) | exclusion | unknown to HOPS |
...
| [maximum matching on bipartite graphs]({{< base >}}html/8Mm5qJ) | unknown to HOPS | exclusion |
...
| [pathwidth+maxdegree]({{< base >}}html/6BWcgd) | unknown to HOPS | unknown to HOPS |
