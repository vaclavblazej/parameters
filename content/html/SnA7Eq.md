...
**Definition:** Minimum over grpah subdivisions, [bandwidth]({{< base >}}html/aP5a38).
...
| [topological bandwidth]({{< base >}}html/SnA7Eq) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
...
* 2013 [The Power of Data Reduction: Kernels for Fundamental Graph Problems by Jansen]({{< base >}}html/FLOjic)
