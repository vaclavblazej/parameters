...
equivalent to: [diameter+max degree]({{< base >}}html/ri9Seh), [bounded components]({{< base >}}html/t7c4mp)



<p><div id="../local_ri9Seh.dot" class="svg-diagram"></div></p><script>Viz.instance().then(function(viz) {fetch('../local_ri9Seh.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);svg.setAttribute("width", "100%");svg.setAttribute("height", "300pt");document.getElementById("../local_ri9Seh.dot").appendChild(svg);svgPanZoom(svg, {zoomEnabled: true,zoomScaleSensitivity: 0.3,minZoom: 0.9,maxZoom: 6,});})});</script>

<p><div id="../dif_inclusions_ri9Seh.dot" class="svg-diagram"></div></p><script>Viz.instance().then(function(viz) {fetch('../dif_inclusions_ri9Seh.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);svg.setAttribute("width", "100%");svg.setAttribute("height", "300pt");document.getElementById("../dif_inclusions_ri9Seh.dot").appendChild(svg);svgPanZoom(svg, {zoomEnabled: true,zoomScaleSensitivity: 0.3,minZoom: 0.9,maxZoom: 6,});})});</script>

<p><div id="../same_inclusions_ri9Seh.dot" class="svg-diagram"></div></p><script>Viz.instance().then(function(viz) {fetch('../same_inclusions_ri9Seh.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);svg.setAttribute("width", "100%");svg.setAttribute("height", "300pt");document.getElementById("../same_inclusions_ri9Seh.dot").appendChild(svg);svgPanZoom(svg, {zoomEnabled: true,zoomScaleSensitivity: 0.3,minZoom: 0.9,maxZoom: 6,});})});</script>
...
| [bisection bandwidth]({{< base >}}html/wUdmUb) | exclusion | unknown to HOPS |
...
| [bounded components]({{< base >}}html/t7c4mp) | upper bound | upper bound |
...
| [carving-width]({{< base >}}html/dS6OgO) | exclusion | upper bound |
...
| [cutwidth]({{< base >}}html/TLx1pz) | exclusion | upper bound |
...
| [degree treewidth]({{< base >}}html/nCWUh3) | exclusion | upper bound |
...
| [genus]({{< base >}}html/gbaHdw) | exclusion | unknown to HOPS |
...
| [pathwidth+maxdegree]({{< base >}}html/6BWcgd) | exclusion | upper bound |
