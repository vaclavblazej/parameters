...
equivalent to: [distance to chordal]({{< base >}}html/OdZQna)
...
| [chordal]({{< base >}}html/Cv1PaJ) | constant | unknown to HOPS |
...
| [distance to block]({{< base >}}html/xNJnFb) | upper bound | unknown to HOPS |
