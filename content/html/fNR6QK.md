---
title: "tree-independence number"
...
<p><div id="../local_fNR6QK.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../local_fNR6QK.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../local_fNR6QK.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>

<p><div id="../graph_property_inclusions_fNR6QK.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../graph_property_inclusions_fNR6QK.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../graph_property_inclusions_fNR6QK.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>

<p><div id="../parameter_inclusions_fNR6QK.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../parameter_inclusions_fNR6QK.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../parameter_inclusions_fNR6QK.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>
...
| [average distance]({{< base >}}html/zH8PpT) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
...
| [bipartite number]({{< base >}}html/1dQQ87) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
...
| [chordal]({{< base >}}html/Cv1PaJ) | <span style="display:none">green</span><span style="color:#006400">■</span> | upper bound | exclusion |
...
| [clique cover number]({{< base >}}html/VomShB) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
...
| [diameter]({{< base >}}html/p4bTjp) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
...
| [distance to block]({{< base >}}html/xNJnFb) | <span style="display:none">green</span><span style="color:#006400">■</span> | upper bound | exclusion |
...
| [distance to chordal]({{< base >}}html/OdZQna) | <span style="display:none">green</span><span style="color:#006400">■</span> | upper bound | exclusion |
...
| [distance to co-cluster]({{< base >}}html/hbfWwE) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
| [distance to cograph]({{< base >}}html/uDXX2i) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
...
| [distance to interval]({{< base >}}html/AVc2K6) | <span style="display:none">green</span><span style="color:#006400">■</span> | upper bound | exclusion |
...
| [domination number]({{< base >}}html/Gq0onN) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
| [domino treewidth]({{< base >}}html/aEs5ap) | <span style="display:none">green</span><span style="color:#006400">■</span> | upper bound | exclusion |
| [edge clique cover number]({{< base >}}html/nYQDv6) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
...
| [iterated type partitions]({{< base >}}html/G1Cwmc) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
...
| [maximum independent set]({{< base >}}html/mHtXUU) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
| [maximum induced matching]({{< base >}}html/GzMYlT) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
...
| [modular-width]({{< base >}}html/4bj71L) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
...
| [neighborhood diversity]({{< base >}}html/vMs3RS) | <span style="display:none">cyan</span><span style="color:#40e0d0">■</span> | unknown to HOPS | exclusion |
...
| [tree-independence number]({{< base >}}html/fNR6QK) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
...
* [assumed]({{< base >}}html/9kg0oo)
    * [tree-independence number]({{< base >}}html/fNR6QK) is equivalent to [tree-independence number]({{< base >}}html/fNR6QK) -- assumed