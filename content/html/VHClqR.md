...
providers: [ISGCI](https://www.graphclasses.org/classes/par_9.html)

**Definition:** Same as treewidth but restricted to have a tree decomposition that is a path.
...
| [pathwidth]({{< base >}}html/VHClqR) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
