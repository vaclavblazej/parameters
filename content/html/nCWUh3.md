---
title: "degree treewidth"
---# degree treewidth

tags: [tree decomposition]({{< base >}}html/bzffn0)

functionally equivalent to: [contraction complexity]({{< base >}}html/LlWzhg), [domino treewidth]({{< base >}}html/aEs5ap), [treespan]({{< base >}}html/IbKkUQ)

**Definition:** an intersetcion of  [maximum degree]({{< base >}}html/UyQ5yM), and [treewidth]({{< base >}}html/5Q7fuR)



<p><div id="../local_nCWUh3.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../local_nCWUh3.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../local_nCWUh3.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>

<p><div id="../graph_property_inclusions_nCWUh3.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../graph_property_inclusions_nCWUh3.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../graph_property_inclusions_nCWUh3.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>

<p><div id="../parameter_inclusions_nCWUh3.dot" class="svg-diagram zoomable"></div></p><script type="module">import { initializeSvgToolbelt } from 'http://localhost:1313/parameters/svg-toolbelt.esm.js';Viz.instance().then(function(viz) {fetch('../parameter_inclusions_nCWUh3.dot').then(response => response.text()).then((data) => {var svg = viz.renderSVGElement(data);document.getElementById("../parameter_inclusions_nCWUh3.dot").appendChild(svg);initializeSvgToolbelt('.zoomable', {zoomStep: 0.3,minScale: 1,maxScale: 5,});})});</script>
...
| [contraction complexity]({{< base >}}html/LlWzhg) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | upper bound | upper bound |
...
| [degree treewidth]({{< base >}}html/nCWUh3) | <span style="display:none">yellow</span><span style="color:#ffd700">■</span> | equal | equal |
...
| [tree-partition-width]({{< base >}}html/QP01gs) | <span style="display:none">red</span><span style="color:#ff0000">■</span> | exclusion | non-tight bounds |
...
* 1999 [A note on domino treewidth by Bodlaender]({{< base >}}html/gcMYuX)
